...
use common\widgets\Translate\components\grid\GridView;
use common\widgets\Translate\components\grid\SerialColumn;
use common\widgets\Translate\components\grid\ActionColumn;
use common\widgets\Translate\components\grid\DataColumn;
use backend\models\search\SourceMessageSearch;
use common\widgets\Translate\assets\AppTranslateAsset;
    ...
    <div class="translations-index">
        <div class="row">
            ...
            <?php   foreach ( [
                ...
                $route = ArrayHelper::merge(['/default'], $params);
        ...
        <h2>
            <?php echo Html::a($this->title, ['/translate']); ?>
            <span class="pull-right btn-group">
            <a class="btn btn-success" href="<?php
            echo Url::to(['/default/rescan']); ?>"><i class="fa fa-refresh"></i> <?php
            ...
            <a class="btn btn-warning btn-ajax" action="translation-clear-cache"
               ...
               href="<?php
               echo Url::to(['/default/clear-cache']); ?>"><i class="fa fa-recycle"></i> <?php
