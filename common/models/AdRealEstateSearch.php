...
class AdRealEstateSearch extends AdRealEstate
{
    ...
    {
        return [
            [['id', 'property', 'type_of_property', 'deal_type', 'place_address_id', 'rooms_in_the_apartment', 'material_housing', 'floor', 'floors_in_the_house', 'area_of_property', 'area_of_land', 'measurement_of_property', 'lease_term', 'price', 'price_for_the_period', 'necessary_furniture', 'internet', 'pets_allowed', 'condition'], 'integer'],
        ];
    }
