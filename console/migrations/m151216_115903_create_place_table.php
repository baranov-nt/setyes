    ...
    public function safeUp()
    {
        ...
        $this->batchInsert('place_country', ['id', 'iso2', 'short_name', 'long_name', 'iso3', 'numcode', 'un_member', 'calling_code', 'cctld', 'phone_number_digits_code',
            ...
            [
                ...
                [13, 'AW', Yii::t('countries', 'Aruba'), 'Aruba', 'ABW', '533', 'no', '2\97', '.aw', null, 'AWG', 0],
                ...
                [16, 'AZ', Yii::t('countries', 'Azerbaijan'), 'Republic of Azerbaijan', 'AZE', '031', 'yes', '\9\94', '.az', 9, 'AZM', 0],
                ...
                [27, 'BO', Yii::t('countries', 'Bolivia'), 'Plurinational State of Bolivia', 'BOL', '068', 'yes', '5\91', '.bo', null, 'BOB', 0],
                ...
                [35, 'BG', Yii::t('countries', 'Bulgaria'), 'Republic of Bulgaria', 'BGR', '100', 'yes', '35\9', '.bg', 9, 'BGL', 0],
                ...
                [50, 'KM', Yii::t('countries', 'Comoros'), 'Union of the Comoros', 'COM', '174', 'yes', '26\9', '.km', null, 'KMF', 0],
                ...
                [64, 'DO', Yii::t('countries', 'Dominican Republic'), 'Dominican Republic', 'DOM', '214', 'yes', '1-80\9', '.do', 10, 'DOP', 0],
                ...
                [69, 'ER', Yii::t('countries', 'Eritrea'), 'State of Eritrea', 'ERI', '232', 'yes', '2\91', '.er', null, 'ERN', 0],
                ...
                [73, 'FO', Yii::t('countries', 'Faroe Islands'), 'The Faroe Islands', 'FRO', '234', 'no', '2\98', '.fo', 5, 'DKK', 0],
                [74, 'FJ', Yii::t('countries', 'Fiji'), 'Republic of Fiji', 'FJI', '242', 'yes', '67\9', '.fj', null, 'FJD', 0],
                ...
                [77, 'GF', Yii::t('countries', 'French Guiana'), 'French Guiana', 'GUF', '254', 'no', '5\94', '.gf', null, 'EUR', 0],
                [78, 'PF', Yii::t('countries', 'French Polynesia'), 'French Polynesia', 'PYF', '258', 'no', '68\9', '.pf', 6, 'XPF', 0],
                ...
                [82, 'GE', Yii::t('countries', 'Georgia'), 'Georgia', 'GEO', '268', 'yes', '\9\95', '.ge', 9, 'GEL', 0],
                [83, 'DE', Yii::t('countries', 'Germany'), 'Federal Republic of Germany', 'DEU', '276', 'yes', '4\9', '.de', 10, 'EUR', 0],
                ...
                [87, 'GL', Yii::t('countries', 'Greenland'), 'Greenland', 'GRL', '304', 'no', '2\9\9', '.gl', 6, 'DKK', 0],
                ...
                [95, 'GY', Yii::t('countries', 'Guyana'), 'Co-operative Republic of Guyana', 'GUY', '328', 'yes', '5\92', '.gy', null, 'GYD', 0],
                [96, 'HT', Yii::t('countries', 'Haiti'), 'Republic of Haiti', 'HTI', '332', 'yes', '50\9', '.ht', null, 'HTG', 0],
                ...
                [109, 'IT', Yii::t('countries', 'Italy'), 'Italian Republic', 'ITA', '380', 'yes', '3\9', '.jm', 10, 'EUR', 0],
                ...
                [119, 'KG', Yii::t('countries', 'Kyrgyzstan'), 'Kyrgyz Republic', 'KGZ', '417', 'yes', '\9\96', '.kg', null, 'KGS', 0],
                ...
                [130, 'MK', Yii::t('countries', 'Macedonia'), 'The Former Yugoslav Republic of Macedonia', 'MKD', '807', 'yes', '38\9', '.mk', 8, 'MKD', 0],
                ...
                [137, 'MH', Yii::t('countries', 'Marshall Islands'), 'Republic of the Marshall Islands', 'MHL', '584', 'yes', '6\92', '.mh', 7, 'USD', 0],
                [138, 'MQ', Yii::t('countries', 'Martinique'), 'Martinique', 'MTQ', '474', 'no', '5\96', '.mq', null, 'EUR', 0],
                ...
                [143, 'FM', Yii::t('countries', 'Micronesia'), 'Federated States of Micronesia', 'FSM', '583', 'yes', '6\91', '.fm', 7, 'USD', 0],
                ...
                [172, 'PY', Yii::t('countries', 'Paraguay'), 'Republic of Paraguay', 'PRY', '600', 'yes', '5\95', '.py', null, 'PYG', 0],
                ...
                [178, 'PR', Yii::t('countries', 'Puerto Rico'), 'Commonwealth of Puerto Rico', 'PRI', '630', 'no', '1-\93\9', '.pr', 10, 'USD', 0],
                ...
                [184, 'BL', Yii::t('countries', 'Saint Barthelemy'), 'Saint Barth&eacute;lemy', 'BLM', '652', 'no', '5\90', '.bl', null, 'EUR', 0],
                [185, 'SH', Yii::t('countries', 'Saint Helena'), 'Saint Helena, Ascension and Tristan da Cunha', 'SHN', '654', 'no', '2\90', '.sh', 4, 'SHP', 0],
                [186, 'KN', Yii::t('countries', 'Saint Kitts and Nevis'), 'Federation of Saint Christopher and Nevis', 'KNA', '659', 'yes', '1-86\9', '.kn', 10, 'XCD', 0],
                [187, 'LC', Yii::t('countries', 'Saint Lucia'), 'Saint Lucia', 'LCA', '662', 'yes', '1-758', '.lc', 10, 'XCD', 0],
                [188, 'MF', Yii::t('countries', 'Saint Martin'), 'Saint Martin', 'MAF', '663', 'no', '5\90', '.mf', null, 'EUR', 0],
                ...
                [211, 'SD', Yii::t('countries', 'Sudan'), 'Republic of the Sudan', 'SDN', '729', 'yes', '24\9', '.sd', null, 'SDG', 0],
                [212, 'SR', Yii::t('countries', 'Suriname'), 'Republic of Suriname', 'SUR', '740', 'yes', '5\97', '.sr', null, 'SRG', 0],
                ...
                [219, 'TJ', Yii::t('countries', 'Tajikistan'), 'Republic of Tajikistan', 'TJK', '762', 'yes', '\9\92', '.tj', null, 'TJR', 0],
                ...
                [224, 'TK', Yii::t('countries', 'Tokelau'), 'Tokelau', 'TKL', '772', 'no', '6\90', '.tk', null, 'NZD', 0],
                ...
                [229, 'TM', Yii::t('countries', 'Turkmenistan'), 'Turkmenistan', 'TKM', '795', 'yes', '\9\93', '.tm', null, 'TMM', 0],
                [230, 'TC', Yii::t('countries', 'Turks and Caicos Islands'), 'Turks and Caicos Islands', 'TCA', '796', 'no', '1-64\9', '.tc', 10, 'USD', 0],
                ...
                [238, 'UY', Yii::t('countries', 'Uruguay'), 'Eastern Republic of Uruguay', 'URY', '858', 'yes', '5\98', '.uy', null, 'UYU', 0],
                [239, 'UZ', Yii::t('countries', 'Uzbekistan'), 'Republic of Uzbekistan', 'UZB', '860', 'yes', '\9\98', '.uz', null, 'UZS', 0],
                [240, 'VU', Yii::t('countries', 'Vanuatu'), 'Republic of Vanuatu', 'VUT', '548', 'yes', '678', '.vu', null, 'VUV', 0],
                [241, 'VA', Yii::t('countries', 'Vatican City'), 'State of the Vatican City', 'VAT', '336', 'no', '3\9', '.va', 10, 'EUR', 0],
