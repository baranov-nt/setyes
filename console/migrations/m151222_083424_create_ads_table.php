...
class m151222_083424_create_ads_table extends Migration
{
    public function safeUp()
    {
        ...
        $this->createTable('ads', [
            ...
            'style_id' => $this->integer()->defaultValue(1),                  // Стиль для объявления (по умолчанию 1)
        ...
        $this->addForeignKey('place_ads', 'ads', 'place_id', 'place', 'id', 'CASCADE');
        $this->addForeignKey('user_ads', 'ads', 'user_id', 'user', 'id', 'CASCADE');
        ...
        $this->addForeignKey('style_ads', 'ads', 'style_id', 'ads_style', 'id', 'CASCADE');
        ...
        $this->createTable('ads_category', [
            'id' => $this->primaryKey(),
            'realestate_id' => $this->integer(),                                       // Категория для недвижемости
        ...
        $this->addForeignKey('category_ads', 'ads', 'categoty_id', 'ads_category', 'id', 'CASCADE');
    }
