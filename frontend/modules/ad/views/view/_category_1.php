...
echo AdWidget::widget([
    ...
    'favorite_icon_empty' => $model->adCategory->adMain->adStyle->favorite_icon,
    'complain' => $model->adCategory->adMain->getComplain($model->adCategory->adMain->id),
    'complain_icon' => $model->adCategory->adMain->adStyle->complain_icon,
